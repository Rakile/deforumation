...
For MAC users, copy the websocket version of Deforum ("Deforum_version\Websockets_version_of_deforum\deforum-for-automatic1111-webui")
...
For users that want to use named pipes version (recommended for Windows and Linux users) of deforum/deforumation, copy the folder in "Deforum_version\Named_Pipes_version_of_deforum\deforum-for-automatic1111-webui".
to your extentions folder in Automatic1111. (Be sure to delete any old folder of Deforum, or overwrite the old one when asked.)
...
For users that want to use websocket version of deforum/deforumation, copy the folder in "Deforum_version\Websockets_version_of_deforum\deforum-for-automatic1111-webui" to your extentions folder in Automatic1111. (Be sure to delete any old folder of Deforum, or overwrite the old one when asked.)
