`Deforumation 0.7.6 No more updates will be dome to this repo. Se new repo for DeforumationQT Version 0.1.5
...
Join our Discord https://discord.gg/UZvrg7ph9k
===============================================
LAInol: [YouTube Channel](https://www.youtube.com/@lainolkar)
-------------
...
Also added customizable curves for use with armed motions controls. Parameters for up to five controlnets. Cadence Re-Scheduler, this is a module to recalculate the
Cadence Schedule due to "tween" pictures not reacting to schedueled values. 
...
-------------
[Installation Tutorial](https://youtu.be/7KmtmPlhzNs)  (Tutorial is for websocket protocol, follow the above installation guide to use named pipes protocol)
